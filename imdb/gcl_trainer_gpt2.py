...
# fim_model_name = "/home/gong112/service_backup/work/zhaorun/SS-RLHF/imdb_finetune/gpt2-imdb-fim-64"  # You can replace this with other GPT-2 variants if needed
# tokenizer = AutoTokenizer.from_pretrained(fim_model_name)
# tokenizer.pad_token = tokenizer.eos_token
# model = AutoModelForCausalLM.from_pretrained(fim_model_name)

cost_model_name = "/home/xyq/.cache/huggingface/hub/models--lvwerra--gpt2-imdb/snapshots/f1bfd819c6bee6c18fa5f95bfe88d9198839a435/"
tokenizer = AutoTokenizer.from_pretrained(cost_model_name)
tokenizer.pad_token = tokenizer.eos_token
...
def preprocess_function(examples):
    ...
    for idx in tqdm(range(len(argu_idx)-1), desc="preparing data for gcl", total=len(argu_idx)-1):
...
# )
# train_dataset.save_to_disk("gcl/train_dataset")

# input("save to disk")
train_dataset = load_from_disk("/home/xyq/.conda/trl/imdb/gcl/train_dataset_bigger")
...
print("device:",cost_model.device)
