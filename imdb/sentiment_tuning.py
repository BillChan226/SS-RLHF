...
class ScriptArguments:
    ...
    mini_batch_size: Optional[int] = field(default=48, metadata={"help": "the PPO minibatch size"})
    batch_size: Optional[int] = field(default=48, metadata={"help": "the batch size"})
