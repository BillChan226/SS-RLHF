...
3. RL fine-tuning of llama-7b-se with the llama-7b-se-rm reward model:
    - `accelerate launch --multi_gpu --num_machines 1  --num_processes 2 /home/xyq/.conda/trl/examples/research_projects/stack_llama/scripts/rl_training.py --log_with=tensorboard --model_name=trl-lib/llama-7b-se-peft --reward_model_name=trl-lib/llama-7b-se-rm-peft --adafactor=False --tokenizer_name=meta-llama/Llama-2-7b-hf --save_freq=100 --output_max_length=128 --batch_size=8 --gradient_accumulation_steps=8 --batched_gen=True --ppo_epochs=4 --seed=0 --learning_rate=1.4e-5 --early_stopping=True --output_dir=llama-se-rl-finetune-128-8-8-1.4e-5_adam`
